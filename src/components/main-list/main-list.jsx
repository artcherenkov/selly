  ...
  return (
    <ul className="results__list">
      <li className="results__item product">
        ...
        <div className="product__image">
          ...
          <div className="product__image-navigation">
            ...
            <span className="product__navigation-item"/> <span className="product__navigation-item"/></div>
        </div>
      ...
      <li className="results__item product">
        ...
        <div className="product__image">
          <div className="product__image-more-photo hidden">+2 фото</div>
          <img src="img/item2.jpg" srcSet="img/item2-2x.jpg 2x" width="318" height="220" alt="Ford Mustang 2020"/>
      ...
      <li className="results__item product">
        ...
        <div className="product__image">
          <div className="product__image-more-photo hidden">+2 фото</div>
          <img src="img/item3.jpg" srcSet="img/item3-2x.jpg 2x" width="318" height="220" alt="Фотокамера Canon EOS 5D + объектив"/>
          <div className="product__image-navigation hidden">
            <span className="product__navigation-item product__navigation-item--active"/>
            <span className="product__navigation-item"/> <span className="product__navigation-item"/>
            <span className="product__navigation-item"/> <span className="product__navigation-item"/></div>
      ...
      <li className="results__item product">
        ...
        <div className="product__image">
          <div className="product__image-more-photo hidden">+2 фото</div>
          <img src="img/item4.jpg" srcSet="img/item4-2x.jpg 2x" width="318" height="220" alt="1-комнатная квартира в центре Питера"/>
          <div className="product__image-navigation hidden">
            <span className="product__navigation-item product__navigation-item--active"/>
            <span className="product__navigation-item"/> <span className="product__navigation-item"/>
            <span className="product__navigation-item"/> <span className="product__navigation-item"/></div>
      ...
      <li className="results__item product">
        ...
        <div className="product__image">
          <div className="product__image-more-photo hidden">+2 фото</div>
          <img src="img/item5.jpg" srcSet="img/item5-2x.jpg 2x" width="318" height="220" alt="Ультрабук HP Spectre X360 2019"/>
          <div className="product__image-navigation hidden">
            <span className="product__navigation-item product__navigation-item--active"/>
            <span className="product__navigation-item"/> <span className="product__navigation-item"/>
            <span className="product__navigation-item"/> <span className="product__navigation-item"/></div>
      ...
      <li className="results__item product">
        ...
        <div className="product__image">
          ...
          <img src="img/item6.jpg" srcSet="img/item6-2x.jpg 2x" width="318" height="220" alt="ВАЗ 2101 на ходу, без документов"/>
          <div className="product__image-navigation hidden">
            <span className="product__navigation-item product__navigation-item--active"/>
            <span className="product__navigation-item"/> <span className="product__navigation-item"/>
            <span className="product__navigation-item"/> <span className="product__navigation-item"/></div>
